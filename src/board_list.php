...
<body>
        <div class= "list_container">
            <h1 class= "list_title">게시판</h1>
            <div class="table_page_no">
                <div class= "table_all">
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col" class = "board_no" >게시글 번호</th>
                                <th scope="col" class = "board_title" >게시글 제목</th>
                                <th scope="col" class = "board_time">작성일자</th>
                            </tr>
                        </thead>
                            <tbody class="table-group-divider">
                                ...
                                ?>
                                        <tr>
                                        <th scope="row"><?php echo $recode["board_no"] ?></th>
                ...
                <div class= "a_tag">
                    ...
                    {
                    ?>
                        <!-- <a href='board_list.php?page_num=<?php //echo $page_num ?>'>></a> -->
